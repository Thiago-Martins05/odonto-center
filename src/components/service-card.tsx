...
export function ServiceCard({ slug, name, description, priceCents, durationMin }: ServiceCardProps) {
  const fallbackDescription = "Atendimento realizado por profissionais qualificados.";
    ...
    <Card className="rounded-2xl transition-all duration-200 hover:shadow-lg hover:shadow-gray-200/50">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-gray-700 font-medium">
          Preço: {brl.format(priceCents / 100)} • Duração: {durationLabel(durationMin)}
        </div>
